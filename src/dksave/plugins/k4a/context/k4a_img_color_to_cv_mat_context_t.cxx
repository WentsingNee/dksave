/**
 * @file       k4a_img_color_to_cv_mat_context_t.cxx
 * @brief
 * @date       2022-10-12
 * @author     Wentsing Nee
 * @copyright
...
export module dksave.plugins.k4a.context.k4a_img_color_to_cv_mat_context_t;
...
namespace dksave::plugins_k4a
{
	...
	struct k4a_img_color_to_cv_mat_context_t
	{
			...
			cv::Mat & convert(const k4a::image & k4a_img_color)
			{
				...
				this->cv_color_img_with_alpha = cv::Mat(
					k4a_img_color.get_height_pixels(),
					k4a_img_color.get_width_pixels(),
					CV_8UC4,
					(void *) (k4a_img_color.get_buffer())
				);
				cv::cvtColor(
					this->cv_color_img_with_alpha,
					this->cv_color_img_without_alpha,
					cv::COLOR_BGRA2BGR
				);
